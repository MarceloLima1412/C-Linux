/*
  ...
  gengetopt --no-help --file-name=args 
...
const char *gengetopt_args_info_purpose = "2160866-2192236";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -c, --compact          Parametro compact",
  "  -d, --dir=STRING       Parametro dir",
  "      --discrete=STRING  Parametro discrete",
  "  -f, --file=STRING      Parametro file",
  "  -h, --help             Parametro help",
  "  -m, --mode=SHORT       Parametro mode",
  "  -o, --output=STRING    Parametro output",
  "  -s, --search=STRING    Parametro search",
  "      --time             Parametro time",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->compact_help = gengetopt_args_info_help[1] ;
  ...
  args_info->help_help = gengetopt_args_info_help[5] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "Vcd:f:hm:o:s:", long_options, &option_index);
