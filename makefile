...
PROGRAM_OBJS=main.o tratadir.o debug.o help.o readfile.o discrete.o memory.o $(PROGRAM_OPT).o
...
# Dependencies
main.o: main.c help.h debug.h memory.h $(PROGRAM_OPT).h
$(PROGRAM_OPT).o: $(PROGRAM_OPT).c $(PROGRAM_OPT).h
help.o: help.c help.h
readfile.o: readfile.c readfile.h
discrete.o: discrete.c discrete.h
debug.o: debug.c debug.h
memory.o: memory.c memory.h
tratadir.o: tratadir.c tratadir.h
...
$(PROGRAM_OPT).c $(PROGRAM_OPT).h: $(PROGRAM_OPT).ggo
	gengetopt --no-help < $(PROGRAM_OPT).ggo --file-name=$(PROGRAM_OPT)
