...
const char *gengetopt_args_info_purpose = "2160866 - Marcelo Lima";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -c, --compact=STRING   Parametro compact",
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "Vc:d:f:hm:o:s:", long_options, &option_index);
